...
* 可忽略的自定义字段
* @author lin.qiongshan
* @date 2016年8月18日10:01:15
* @desc 表示有自定义字段，但客户端可忽略的。目的是用于处理那些有自定义字段，但自定义字段格式还不完全确定，又不是必须的类型
*/
//class ResponseIgnoreCustomHeader : public CommandCustomHeader
//{};

//class RequestIgnoreCustomHeader : public CommandCustomHeader
//{};

/**
* 未实现的自定义字段
* @author lin.qiongshan
* @date 2016年8月18日10:03:08
* @desc 表示有自定义字段，还不完全确定格式的，但又必须的类型。如果有这样的类型，后面必须提供相应的 CommandCustomHeader 类型来处理，这个类相当于一个标记
*/
//class ResponseNotImplCustomHeader : public CommandCustomHeader
//{};

//class RequestNotImplCustomHeader : public CommandCustomHeader
//{};
